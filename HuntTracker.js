              ...
              {(equity).map(e=>(
                <div key={e.id}
                  ...
                  {e.rollAmount>0 && (e.amount-e.rollAmount)>0 ? (
                    ...
                    <input key={e.id} type="number" defaultValue={e.amount>0?e.amount:''} onChange={ev=>updatePerson(e.id,'amount',ev.target.value)} style={{...inp,height:34,fontSize:13,fontWeight:600}} />
                  )}
                  <div style={{display:'flex',gap:2,alignItems:'center'}}>
                    ...
                    style={{height:34,width:30,background:'rgba(74,222,128,0.1)',border:`1px solid rgba(74,222,128,0.35)`,borderRadius:4,cursor:'pointer',color:G.green,fontSize:18,fontFamily:G.mono,fontWeight:700,display:'flex',alignItems:'center',justifyContent:'center'}}
